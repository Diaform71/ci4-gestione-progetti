                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <!-- <div class="btn-group btn-group-sm"> -->
                                <a href="<?= base_url('progetti/edit/' . $progetto['id']) ?>" class="btn btn-primary btn-sm">
                                    <i class="fas fa-edit"></i> Modifica
                                </a>
                                <a href="<?= base_url('progetti/toggle-attivo/' . $progetto['id']) ?>" class="btn <?= $progetto['attivo'] ? 'btn-warning' : 'btn-success' ?> btn-sm">
                                    <i class="fas <?= $progetto['attivo'] ? 'fa-ban' : 'fa-check' ?>"></i> 
                                    <?= $progetto['attivo'] ? 'Disattiva' : 'Attiva' ?>
                                </a>
                                <a href="javascript:void(0)" class="btn btn-danger btn-elimina-progetto btn-sm" data-id="<?= $progetto['id'] ?>" data-nome="<?= esc($progetto['nome']) ?>">
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <button type="button" class="btn btn-success btn-sm " id="btnStampaMateriali">
                            <i class="fas fa-print"></i> Stampa
                        </button>
                        <button type="button" class="btn btn-warning btn-sm" id="btnCreaRichiesta" disabled>
            ...
            <div class="card-body">
                <ul class="nav nav-tabs" id="materialiTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="vista-standard-tab" data-toggle="tab" href="#vista-standard" role="tab" aria-controls="vista-standard" aria-selected="true">
                            Vista Standard
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="vista-categorie-tab" data-toggle="tab" href="#vista-categorie" role="tab" aria-controls="vista-categorie" aria-selected="false">
                            Vista per Categorie
                        </a>
                    </li>
                </ul>
                ...
                <div class="tab-content pt-3" id="materialiTabContent">
                    <!-- Vista Standard -->
                    <div class="tab-pane fade show active" id="vista-standard" role="tabpanel" aria-labelledby="vista-standard-tab">
                                    ...
                                    <tbody>
                                        <?php foreach($materiali as $materiale): ?>
                                            <tr>
                                                <td>
                                                    <div class="icheck-primary">
                                                        <input type="checkbox" class="materiale-checkbox" id="materiale<?= $materiale['id'] ?>" value="<?= $materiale['id'] ?>">
                                                ...
                                                <td>
                                                    <a href="<?= base_url('materiali/show/' . $materiale['id_materiale']) ?>" class="text-dark">
                                                ...
                                                <td><?= !empty($materiale['note']) ? esc($materiale['note']) : '<span class="text-muted">-</span>' ?></td>
                                                <td>
                                                    <div class="btn-group">
                    ...
                    <!-- Vista per Categorie -->
                    <div class="tab-pane fade" id="vista-categorie" role="tabpanel" aria-labelledby="vista-categorie-tab">
                        <?php if(isset($materiali) && !empty($materiali)):
                        ...
                        ?>
                            <div class="card mb-4">
                                <div class="card-header bg-<?= $categoria['classe'] ?> text-white">
                                    <h5 class="mb-0">
                                        <?= $categoria['titolo'] ?> 
                                        <span class="badge badge-light"><?= count($materialiPerCategoria[$codiceCategoria]) ?></span>
                                    </h5>
                                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <div class="input-group">
                            <input type="text" class="form-control" id="searchMateriale" placeholder="Cerca per codice o descrizione...">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form id="formNuovoMateriale" action="<?= base_url('progetti/aggiungi-nuovo-materiale/' . $progetto['id']) ?>" method="post">
                            <?= csrf_field() ?>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="codiceMateriale">Codice *</label>
                                        <input type="text" class="form-control" id="codiceMateriale" name="codice" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="produttoreMateriale">Produttore</label>
                                        <input type="text" class="form-control" id="produttoreMateriale" name="produttore">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="descrizioneMateriale">Descrizione *</label>
                                <textarea class="form-control" id="descrizioneMateriale" name="descrizione" rows="2" required></textarea>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="quantitaMateriale">Quantità *</label>
                                        <input type="number" class="form-control" id="quantitaMateriale" name="quantita" min="0.01" step="0.01" value="1" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="commercialeMateriale" name="commerciale" value="1">
                                            <label class="form-check-label" for="commercialeMateriale">Commerciale</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="meccanicaMateriale" name="meccanica" value="1">
                                            <label class="form-check-label" for="meccanicaMateriale">Meccanica</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="elettricaMateriale" name="elettrica" value="1">
                                            <label class="form-check-label" for="elettricaMateriale">Elettrica</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="pneumaticaMateriale" name="pneumatica" value="1">
...
<div class="modal fade" id="modalQuantitaMateriale" tabindex="-1" role="dialog" aria-labelledby="modalQuantitaMaterialeLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="formAggiungiMateriale" action="<?= base_url('progetti/aggiungi-materiale/' . $progetto['id']) ?>" method="post">
                <div class="modal-body">
                    <?= csrf_field() ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="quantita" name="quantita" min="0.01" step="0.01" value="1" required>
...
<div class="modal fade" id="modalModificaMateriale" tabindex="-1" role="dialog" aria-labelledby="modalModificaMaterialeLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="formModificaMateriale" action="<?= base_url('progetti/aggiorna-materiale/' . $progetto['id']) ?>" method="post">
                <div class="modal-body">
                    <?= csrf_field() ?>
...
<div class="modal fade" id="modalCreaRichiesta" tabindex="-1" role="dialog" aria-labelledby="modalCreaRichiestaLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form id="formCreaRichiesta" action="<?= base_url('richieste-offerta/create-from-project') ?>" method="post">
                <div class="modal-body">
                    <?= csrf_field() ?>
                    <input type="hidden" name="id_progetto" value="<?= $progetto['id'] ?>">
    ...
    $(document).ready(function() {
        ...
        $('#btnCreaRichiesta').click(function() {
            ...
            if ($('#titoloRichiesta').val() === '') {
                $('#titoloRichiesta').val('RDO per <?= esc($progetto['nome']) ?> - ' + new Date().toLocaleDateString('it-IT'));
            }
        ...
        function preparaStampaVistaStandard() {
            ...
            content += '<table>';
            content += '<thead><tr><th>Codice</th><th>Descrizione</th><th>Quantità</th><th>UM</th><th>Categorie</th><th>Note</th></tr></thead>';
            content += '<tbody>';
        ...
        function preparaStampaVistaCategorie() {
            ...
            $('#vista-categorie .card').each(function() {
                ...
                const categoriaClass = $(this).find('.card-header').attr('class').split('bg-')[1].split(' ')[0];
                
                content += `<div class="categoria-header bg-${categoriaClass}">${categoriaTitle}</div>`;
                content += '<table>';
                content += '<thead><tr><th>Codice</th><th>Descrizione</th><th>Produttore</th><th>Quantità</th><th>UM</th><th>Note</th></tr></thead>';
                content += '<tbody>';
        ...
        function cercaMateriali() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                beforeSend: function() {
                    $('#materialiRisultati').html('<tr><td colspan="4" class="text-center"><i class="fas fa-spinner fa-spin"></i> Ricerca in corso...</td></tr>');
                },
                success: function(response) {
                    $('#materialiRisultati').empty();
                    
                    if(response.length === 0) {
                        $('#materialiRisultati').html('<tr><td colspan="4" class="text-center">Nessun materiale trovato. Prova con una ricerca diversa o aggiungi un nuovo materiale.</td></tr>');
                        return;
                    }
                ...
                error: function(xhr, status, error) {
                    $('#materialiRisultati').html('<tr><td colspan="4" class="text-center text-danger">Errore durante la ricerca. Riprova.</td></tr>');
                    console.error(error);
                }
            });
        }
        ...
        $('.btn-rimuovi-materiale').click(function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '<?= base_url('progetti/rimuovi-materiale/' . $progetto['id'] . '/') ?>' + id;
                }
            });
        });
    });
