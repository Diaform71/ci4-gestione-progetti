...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><?= $title ?? 'Nuovo Utente' ?></h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Inserisci Nuovo Utente</h3>
            </div>
            <form action="<?= base_url('utenti/create') ?>" method="post" id="form-nuovo-utente">
                <?= csrf_field() ?>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <?php endif; ?>
                                <small class="form-text text-muted">La password deve essere di almeno 8 caratteri.</small>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control <?= session('errors.ruolo') ? 'is-invalid' : '' ?>" 
                                    ...
                                    <option value="user" <?= old('ruolo') === 'user' ? 'selected' : '' ?>>Utente Standard</option>
