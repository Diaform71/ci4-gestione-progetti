                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <span class="badge badge-<?php 
                            switch($ordine['stato']) {
                                case 'bozza': echo 'secondary'; break;
                                case 'confermato': echo 'success'; break;
                                case 'in_attesa': echo 'warning'; break;
                                case 'inviato': echo 'info'; break;
                                case 'completato': echo 'primary'; break;
                                case 'annullato': echo 'danger'; break;
                                case 'in_consegna': echo 'warning'; break;
                        ...
                        ?>">
                            <?php 
                                switch($ordine['stato']) {
                                    case 'bozza': echo 'Bozza'; break;
                                    case 'confermato': echo 'Confermato'; break;
                                    case 'in_attesa': echo 'In Attesa'; break;
                                    case 'inviato': echo 'Inviato'; break;
                                    case 'completato': echo 'Completato'; break;
                                    case 'annullato': echo 'Annullato'; break;
                                    case 'in_consegna': echo 'In Consegna'; break;
                                    case 'consegnato': echo 'Consegnato'; break;
                                    default: echo ucfirst($ordine['stato']);
                                }
                            ?>
                        </span>
                    </div>
