...
final class OffertaFornitoreAllegatoModel extends Model
{
    protected $table            = 'offerte_fornitore_allegati';
    ...
    protected $allowedFields    = [
        'id_offerta_fornitore', 'nome_file', 'file_originale', 'dimensione', 
    ...
    /**
     * Ottiene tutti gli allegati di una specifica offerta fornitore
     */
    public function getAllegatiByOfferta(int $idOfferta)
    {
        return $this->select('offerte_fornitore_allegati.*, utenti.nome as nome_utente, utenti.cognome as cognome_utente')
            ->join('utenti', 'utenti.id = offerte_fornitore_allegati.id_utente', 'left')
            ->where('offerte_fornitore_allegati.id_offerta_fornitore', $idOfferta)
            ->orderBy('offerte_fornitore_allegati.data_caricamento', 'DESC')
            ->findAll();
    }
     ...
     *
     * @param int $idOfferta ID dell'offerta fornitore
     ...
     */
    public function uploadFile(int $idOfferta, $file, int $idUtente, string $descrizione = '')
    {
        ...
        $uploadPath = FCPATH . 'uploads/offerte_fornitore/' . $idOfferta;
